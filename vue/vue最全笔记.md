...
![](vue最全笔记.assets/3.3-1-1620905966273.png)
...
```
 ...
 使用 books 数组对象记录 book 数据，使用 totalPrice 计算属性计算总价。
...
![](vue最全笔记.assets/12.1-1.png)

![](vue最全笔记.assets/12.1-2.png)
...
![生命周期图](vue最全笔记.assets/lifecycle.png)
...
![reslut](vue最全笔记.assets/1-1620906341243.png)
...
![2](vue最全笔记.assets/2-1620906341243.png)
...
结果:
![有el](vue最全笔记.assets/3-1620906341243.png)
...
结果：
![无el](vue最全笔记.assets/4-1620906341243.png)
...
![template](vue最全笔记.assets/5-1620906341243.png)
...
结果：
![template](vue最全笔记.assets/6-1620906341243.png)
...
![7](vue最全笔记.assets/7-1620906341244.png)
...
结果：
![10](vue最全笔记.assets/10.png)

> 注意只有写入模板的数据才会被追踪

### 13.2.6 beforeDestroy 和 destroyed 钩子函数间的生命周期

![11](vue最全笔记.assets/11.png)
...
![](vue最全笔记.assets/15-16.png)

**5.如何使用 file-loader，指定路径**

修改webpack.config.js中 output 属性
...
![](vue最全笔记.assets/15-27.png)

打包后，查看 bundle.js，结果如图所示：

![](vue最全笔记.assets/15-28.png)
...
![](vue最全笔记.assets/16-2.png)

其中build和config都是配置相关的文件。

### 16.2.1	build和config

![](vue最全笔记.assets/16-3.png)
...
<img src="VueLearnNotes/16-vue-cli/images/16-11.png" />

再次打开当前目录下的`lib`文件夹，发现配置文件`service.js`，并导入了许多模块，来自与lib下面的config、util等模块

![](vue最全笔记.assets/16-11.png)
...
1. 在文件夹 assest 下新建 css/base.css,用于初始化 css
   ...
   <img src="VueLearnNotes/17-vue-router/images/17-27.png" style="zoom:75%;" />
